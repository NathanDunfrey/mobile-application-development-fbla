...
class BooksCarouselView extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    console.log("Inside UserBooksCarouselView render");
      ...
      <Container style={tomelystyles.container}>
        <Header style={{ backgroundColor: "dodgerblue", marginTop: 10 }}>
          ...
          >
            <Title>Welcome</Title>
            <Subtitle>
              {this.props.navigation.state.params.userProfile.first_name}{" "}
              {this.props.navigation.state.params.userProfile.last_name}
            </Subtitle>
          </Body>
...
export default BooksCarouselView;
